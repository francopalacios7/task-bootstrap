...
fetch("https://mindhub-xj03.onrender.com/api/amazing")
  ...
  .then(res => {
    ...
    showCards(dataEvents.events, section);
  })
...
function cards(card) {
  ...
  div.innerHTML = `<section id="section" class="card m-5 m-sm-4 m-md-2" style="width: 22rem;">
                    ...
                    <div class="card-body d-flex justify-content-between">
                      ...
                      <a href="./assets/pages/details.html?id=${card._id}" class="card-link">See more</a>
                    </div>
                  </section>`
...
function filter() {
  ...
  let filterBySearchResult = filterBySearch(dataEvents.events, searchBar.value)
